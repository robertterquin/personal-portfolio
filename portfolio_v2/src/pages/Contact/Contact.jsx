          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className={`mt-16 transition-all duration-700 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <div className="flex justify-center gap-4">
                <a href="#" className="w-12 h-12 rounded-full border border-gray-800 bg-gray-900/50 backdrop-blur-sm flex items-center justify-center text-gray-400 hover:text-mono-800 hover:border-mono-500/50 transition-all hover:scale-110">
